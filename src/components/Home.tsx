...
const Home = () => {
  ...
  return (
    <div>
      <div className="bg-black relative px-4 text-white md:px-0">
        {isLoading && <Loading />}

        <div className="container mx-auto min-h-[calc(100vh-77-px)] flex items-center relative">
          <div className="flex-col md:flex-row flex gap-10 md:mx-10 py-20">
            ...
            <div className="space-y-6">
              <div className="uppercase -translate-y-3 text-2xl md:text-3xl font-bold text-white">
                {movie?.title}
              </div>
              ...
              <div
                ...
                <div className="flex gap-2 items-center bg-white text-black px-4  mb-6 hover:bg-[#b4b4b4]">
                  <BsPlayFill size={24} />
                  Watch Trailer
                </div>
              </div>
